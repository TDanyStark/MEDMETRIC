...
export const ROLE_BLUEPRINTS: Record<Role, RoleBlueprint> = {
  ...
  rep: {
    ...
    navigation: [
      { to: '/rep', label: 'Panorama', description: 'Inicio del visitador con accesos rapidos a contenido y sesiones.', phase: 'Base lista en Fase 8', icon: LayoutDashboard },
      { to: '/rep/library', label: 'Biblioteca', description: 'Materiales aprobados de los gerentes suscritos.', phase: 'Conexion operativa en Fase 10', icon: FolderKanban },
      { to: '/rep/sessions', label: 'Sesiones', description: 'Creacion de sesiones y links para el medico.', phase: 'Conexion operativa en Fase 10', icon: Stethoscope },
      { to: '/rep/history', label: 'Historial', description: 'Seguimiento de sesiones ya creadas y consumos asociados.', phase: 'Conexion operativa en Fase 10', icon: Link2 },
    ],
  },
}

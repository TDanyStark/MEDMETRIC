...
if (!class_exists('Imagick')) {
    class Imagick
    {
        ...
        public function setImageBackgroundColor(string $color): bool
        {
            return true;
        }
        ...
        public function thumbnailImage(int $width, int $height, bool $bestfit = false, bool $fill = false): bool
        {
            return true;
        }
        public function setImageResolution(float $x, float $y): bool
        {
            return true;
        }
